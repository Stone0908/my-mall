<template>
  <div v-show="show" class="load-mark">
    <div class="load-box">
      <div class="loading">
      ...
      <div class="load-content">{{text}}</div>
    </div>
  </div>
</template>
    ...
    .load-box {
        ...
        .loading {
            ...
            .loading_leaf_1:before {
                -webkit-transform: rotate(30deg) translate(20px, 0px);
            ...
            .loading_leaf_2:before {
                -webkit-transform: rotate(60deg) translate(20px, 0px);
            ...
            .loading_leaf_4:before {
                -webkit-transform: rotate(120deg) translate(20px, 0px);
                transform: rotate(120deg) translate(20px, 0px);
            }
            ...
            .loading_leaf_5:before {
                -webkit-transform: rotate(150deg) translate(20px, 0px);
                transform: rotate(150deg) translate(20px, 0px);
            }
            ...
            .loading_leaf_7:before {
                -webkit-transform: rotate(210deg) translate(20px, 0px);
                transform: rotate(210deg) translate(20px, 0px);
            }
            ...
            .loading_leaf_8:before {
                -webkit-transform: rotate(240deg) translate(20px, 0px);
                transform: rotate(240deg) translate(20px, 0px);
            }
            ...
            .loading_leaf_9:before {
                -webkit-transform: rotate(270deg) translate(20px, 0px);
            ...
            .loading_leaf_10:before {
                -webkit-transform: rotate(300deg) translate(20px, 0px);
                transform: rotate(300deg) translate(20px, 0px);
            }
            ...
            .loading_leaf_11:before {
                -webkit-transform: rotate(330deg) translate(20px, 0px);
                transform: rotate(330deg) translate(20px, 0px);
            }
        }
    }
  }
